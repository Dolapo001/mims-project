...
const INDUSTRIES = ["Fashion", "Tech", "Food", "Education", "Health"]
const AGE_GROUPS = ["13–17", "18–24", "25–34", "35–44", "45+"]
const GOALS = ["Awareness", "Engagement", "Conversions"]

export function PredictionForm() {
  const { setResult, setLoading, setError, isLoading } = usePrediction()
